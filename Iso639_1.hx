...
class Iso639_1 {
    ...
    static var _data : Map<String, { rtl:Bool, name:String, nativeName:String }>;
    ...
    public static function data() : Map<String, { rtl:Bool, name:String, nativeName:String }> 
        return _data != null ? _data : _data = [
            ...
            "ny" => { rtl: false, name: "Chichewa,Chewa,Nyanja", nativeName:"chiCheŵa, chinyanja" },
            ...
            "ja" => { rtl: false, name: "Japanese", nativeName:"日本語 (にほんご／にっぽんご)" },
            ...
            "nb" => { rtl: false, name: "Norwegian Bokmål", nativeName:"Norsk bokmål" },
            ...
            "pi" => { rtl: false, name: "Pāli", nativeName:"पाऴि" },
            ...
            "vo" => { rtl: false, name: "Volapük", nativeName:"Volapük" },
